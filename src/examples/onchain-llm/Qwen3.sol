        ...
        assembly ("memory-safe") {
            ...
            for { let i := 0 } lt(i, rows) { i := add(i, 1) } {
                ...
                for { let j := 0 } lt(j, full) { j := add(j, 32) } {
                    ...
                    acc := add(acc, mul(signextend(0, byte(8, w)), mload(add(xq, 0x100))))
                    acc := add(acc, mul(signextend(0, byte(9, w)), mload(add(xq, 0x120))))
                    acc := add(acc, mul(signextend(0, byte(10, w)), mload(add(xq, 0x140))))
                    acc := add(acc, mul(signextend(0, byte(11, w)), mload(add(xq, 0x160))))
                    acc := add(acc, mul(signextend(0, byte(12, w)), mload(add(xq, 0x180))))
                    acc := add(acc, mul(signextend(0, byte(13, w)), mload(add(xq, 0x1a0))))
                    acc := add(acc, mul(signextend(0, byte(14, w)), mload(add(xq, 0x1c0))))
                    acc := add(acc, mul(signextend(0, byte(15, w)), mload(add(xq, 0x1e0))))
                    acc := add(acc, mul(signextend(0, byte(16, w)), mload(add(xq, 0x200))))
                    acc := add(acc, mul(signextend(0, byte(17, w)), mload(add(xq, 0x220))))
                    acc := add(acc, mul(signextend(0, byte(18, w)), mload(add(xq, 0x240))))
                    acc := add(acc, mul(signextend(0, byte(19, w)), mload(add(xq, 0x260))))
                    acc := add(acc, mul(signextend(0, byte(20, w)), mload(add(xq, 0x280))))
                    acc := add(acc, mul(signextend(0, byte(21, w)), mload(add(xq, 0x2a0))))
                    acc := add(acc, mul(signextend(0, byte(22, w)), mload(add(xq, 0x2c0))))
                    acc := add(acc, mul(signextend(0, byte(23, w)), mload(add(xq, 0x2e0))))
                    acc := add(acc, mul(signextend(0, byte(24, w)), mload(add(xq, 0x300))))
                    acc := add(acc, mul(signextend(0, byte(25, w)), mload(add(xq, 0x320))))
                    acc := add(acc, mul(signextend(0, byte(26, w)), mload(add(xq, 0x340))))
                    acc := add(acc, mul(signextend(0, byte(27, w)), mload(add(xq, 0x360))))
                    acc := add(acc, mul(signextend(0, byte(28, w)), mload(add(xq, 0x380))))
                    acc := add(acc, mul(signextend(0, byte(29, w)), mload(add(xq, 0x3a0))))
                    acc := add(acc, mul(signextend(0, byte(30, w)), mload(add(xq, 0x3c0))))
                    acc := add(acc, mul(signextend(0, byte(31, w)), mload(add(xq, 0x3e0))))
                    xq := add(xq, 0x400)
                }
