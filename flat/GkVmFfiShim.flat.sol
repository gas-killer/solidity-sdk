...
pragma solidity <0.9.0 >=0.6.2 ^0.8.12 ^0.8.4;
...
// src/gkvm/testing/GkVmFfiShim.sol
...
contract GkVmFfiShim {
    ...
    fallback(bytes calldata data) external returns (bytes memory) {
        ...
        VmSafe.FfiResult memory result = vm.tryFfi(_gkRunArgs(programHash, artifactRoot, payload, limit));
